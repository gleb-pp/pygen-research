...
Генераторы в Python и горутины в Go представляют собой две разные модели конкурентности для легких задач, котоорые могут приостанавливать контексты выполнения. В этом лабораторном задании я исследую и сравниваю эти модели, чтобы понять, какой ценой и механизмами достигается эта возможность, и какие преимущества и недостатки у каждой модели.
